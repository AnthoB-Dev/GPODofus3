...
Simplement **supprimer le dossier** où vous l'avez décompressé, et si vous le souhaitez, désinstaller **Python** puis **Node** depuis "Ajouter ou supprimer des programmes" sous Windows. 
